...
interface ProducaoTextoFabulaProps {
  contrastMode?: ContrastMode;
}

function ProducaoTextoFabula({ contrastMode = 'default' }: ProducaoTextoFabulaProps) {
    ...
    <div className="my-6">
      <div className="flex items-center gap-3 mb-6">
        <img
          ...
          alt="Ilustração decorativa da seção Produção de texto — Fábula."
